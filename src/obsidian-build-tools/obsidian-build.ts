...
async function main(): Promise<void> {
    ...
    let configSet = require(configFilePath) as ObsidianOptions | ObsidianOptions[];
    ...
    // Process each configuration in the configuration file. This makes any
    // necessary adjustments to the configuration before building, such as
    // replacing the $(Environment) variable with the actual path to the
    ...
    // Define all the builders across the entire set of configurations.
    const builders = configSet.map(config => {
